...
class VolunteerTimeApplyingFragment : Fragment() {
    var binding: FragmentVolunteerTimeApplyingBinding?=null
    ...
    override fun onCreateView(
        ...
        binding= FragmentVolunteerTimeApplyingBinding.inflate(layoutInflater)
        return binding!!.root
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        getInformation()
        //列表没想监听
        binding!!.volunteerTimeApplyingList.setOnItemClickListener { parent, view, position, id ->
    ...
    fun getInformation(){
        ...
        val sql="select `p_name`,`apply_times`,`apply_date`,`p_id` from `project`,`volunteer_project_time` where `project`.`id`=p_id and `v_id`=? and `state`='待审核'"
        ...
        binding!!.volunteerTimeApplyingList.adapter=adapter
    }
}